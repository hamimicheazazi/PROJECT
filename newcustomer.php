...
if (isset($_POST["submit"])) { 
    ...
    $sqlregister = "INSERT INTO `new_customer` (`id`, `name`, `address`,
    `citizenship`, `email`, `phone`, `password`) VALUES('$idno', '$name', '$address', '$citizenship', '$email', '$phone', '$pass')";
try {
...
<body>
    ...
    <p>
       ...
       <img class="w3-image w3-round w3-margin" src="res/images/profile.png" style="width:100%; max-width:400px"><br>
