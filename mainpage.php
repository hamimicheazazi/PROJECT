...
<body>
    <body>
        ...
        <div class="w3-bar w3-black">
            <a href="login.php" class="w3-bar-item w3-button">HOME</a>
...
foreach($rows as $product){
    ...
    echo "<h5><b>$name</h5></b>";
    echo "</header>";
    echo "<img class='w3-image' src=res/images/$name.png" . " onerror=this.onerror=null;this.src='res/images/meals-icon.png'" . " style='width:80%;height:200px'>";
    echo "<div class='w3-container w3-left-align'><hr>";
    echo "<p><div class='w3-center w3-container'>";
    ...
    echo "<a href= 'product_details.php' class='w3-btn w3-red w3-round'>Details</a></p>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
